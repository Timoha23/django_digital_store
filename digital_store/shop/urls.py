...
urlpatterns = [
    ...
    path('shop/<int:shop_id>/create_product/', views.create_product, name='create_product'),
    path('shop/<int:shop_id>/edit_product/<int:product_id>/', views.edit_product, name='edit_product'),
    path('delete_product/<int:product_id>/', views.delete_product, name='delete_product'),
    path('product/<int:product_id>/create_item/', views.create_item, name='create_item'),
